    ...
    <>
      <nav className="flex flex-row items-center py-3 px-6 lg:px-12 shadow-md justify-between bg-white sticky top-0 z-40">
        ...
        <div className="flex flex-row items-center gap-3">
          ...
          {/* profile picture */}
          <div className="rounded-full border border-transparent hover:border-green-600 cursor-pointer transition-all duration-200 overflow-hidden w-10 h-10">
            <img
          ...
          <button
            onClick={logout}
            className="flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-white hover:bg-red-500 px-3 py-2 rounded-lg transition-colors"
          >
            <MdLogout size={16} />
